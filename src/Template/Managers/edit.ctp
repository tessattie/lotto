...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 style="padding-bottom:10px">Editer le Responsable : <?= $manager->first_name." ".$manager->last_name ?></h3>
        </div>
    </div>
    <?= $this->Form->create($manager, ['enctype' => 'multipart/form-data']) ?>
    <fieldset>
        <?php
            ...
            echo $this->Form->control('frais_fonctionnement', array('label' => "Frais de Fonctionnement",'Placeholder' => "HTG"));
