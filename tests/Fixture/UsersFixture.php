...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'ROLEUSERS' => ['type' => 'index', 'columns' => ['role_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'usernameUnique' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
            'ROLEUSERS' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'first_login' => 1,
                'created' => '2019-10-10 14:57:36',
                'modified' => '2019-10-10 14:57:36'
            ],
        ];
        parent::init();
    }
